...
export const projects: Project[] = [
  {
    ...
    description: "SmolLM2-1.7B-UltraChat_200k is a Low-Rank Adaptation (LoRA) of the SmolLM2-1.7B base model by Hugging Face. It was trained using Suptervised Fine-Tuning (SFT) with the ultrachat_200k dataset containing 200k conversational samples generated by GPT-4.",
